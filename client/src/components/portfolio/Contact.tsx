    ...
    >
      {!submitSuccess ? (
        ...
        >
          ...
          <fieldset className="flex flex-col gap-3">
            <label htmlFor="name">
              <input
                ...
                placeholder="NAME *"
                autoComplete="on"
                className="bg-black border border-solid border-white focus:border-rd focus:outline-none w-96 pl-2 py-2"
                required
              />
            </label>
            ...
            <label htmlFor="message">
              <textarea
                ...
                id="message"
                placeholder="MESSAGE *"
                className="bg-black border border-solid border-white focus:border-rd focus:outline-none h-48 w-96 pl-2 py-2"
                required
              ></textarea>
            </label>
          </fieldset>
          ...
          <button
            type="submit"
            className="border border-solid border-white w-96 pl-2 py-2 focus:outline-none focus:text-rd"
          >
            SUBMIT
          </button>
        </form>
