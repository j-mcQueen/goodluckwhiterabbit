...
export default function Sidebar({ ...props }) {
  ...
  return (
    <aside className="grid items-center xl:flex xl:flex-col gap-2 xl:gap-5 xl:min-w-sidebar xl:max-w-sidebar xl:max-h-[calc(100dvh-var(--header)-var(--frame))] xl:border-r border-solid border-white border-b pb-5">
