        ...
        <section className="flex flex-col items-center justify-center h-dvh">
          ...
          >
            <button
              ...
              className="font-vt tracking-vt border border-solid border-white/20 xl:hover:border-red xl:hover:text-rd xl:focus:text-rd xl:hover:drop-shadow-red focus:drop-shadow-red text-xl focus:outline-none xl:focus:border-rd text-white drop-shadow-glo opacity-80 py-1 px-2 xl:hover:bg-red-600 xl:transition-colors"
            >
              ENTER
            </button>
          </motion.div>
