...
export const art_data = [
  ...
  {
    src: TIME,
    title: "TIME IS NEVER PLANNED",
    date: "2024",
    dims: "33 x 26 in. | 84 x 66 cm",
    medium: "Oil on canvas",
    signed: true,
    edition: 1,
    available: true,
  ...
  {
    src: HALF,
    title: "THE HALF OF WHOLE",
    date: "2024",
    dims: "24 x 14 in. | 61 x 36 cm",
    medium: "Oil on canvas",
    signed: true,
    edition: 1,
    available: true,
  ...
  {
    src: CHANCE,
    title: "THE PULL OF CHANCE",
    date: "2024",
    dims: "36 x 42 in. | 91 x 107 cm",
    medium: "Oil on canvas",
    signed: true,
    edition: 1,
    available: true,
